#Importing streamlit package and PIL for images
import streamlit as st
from PIL import Image


#Below method is for images and contains hyperparameter for width, heigh and column_width
...
#Method for the Dashboard respectivly "Page"
def page():
    #In the following part images from the same folder as the app are including in
    ...
    #Title and Markdown are used in the whole file, they are making titles and horizontal lines for visual design
    st.title("XAI for classification of multivariate timeseries")

    st.markdown("<hr style='border:2px solid black'>", unsafe_allow_html=True)

    #Here are the tabs declared for user navigation
    tabs = st.tabs(["Approach", "Classification results", "Explanation Classes 2 & 3"])
    
    #We have here 3 Tabs which has multiple columns and content, they are repeated multiple times and those contain titles, images and expander
    with tabs[0]:
      ...
      with col3:
          ...
          show_image(image_xcm_architecture, use_column_width=True)
      st.markdown("<hr style='border:1px solid black'>", unsafe_allow_html=True)
    ...
    #Here are css statements included for design e.g. the tab visuals
    css = '''
    <style>
...
#The main programm which starts the page method
def main():
